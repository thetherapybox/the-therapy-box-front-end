...
export default function ActivityLibrary() {
  ...
  const filteredProducts =
    ...
    products.filter(
      (activity) =>
        activity.title.toLowerCase().includes(searchFilter.toLowerCase()) ||
    ...
    <>
      <Container>
        <Grid container justify={"space-between"} alignItems={"center"}>
          <Grid item>
            <Typography variant={"h4"} align={"left"} style={styles.pageTitle}>
              Activity Library{" "}
            </Typography>{" "}
          </Grid>{" "}
          <Grid item>
                      ...
                      <Grid item md={4} sm={6} xs={12}>
                        ...
                        >
                          ...
                          <CardContent>
                            <Typography
                              align={"left"}
                              style={styles.activityBoxID}
                            >
                              Activity Box#{" "}
                              {activity.id.slice(activity.id.length - 6)}{" "}
                            </Typography>{" "}
                            <Typography
                              align={"left"}
                              variant={"h6"}
